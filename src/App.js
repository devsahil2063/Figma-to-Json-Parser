...
function App() {
  ...
  const handleGetJson = async () => {
    try {
      ...
      showNotification(
        error.response?.data?.message || "Error fetching JSON",
        "error"
      );
    }
  };
      ...
      >
        ...
        >
          <Typography
            variant="h6"
            gutterBottom
            sx={{ mb: 3, fontWeight: "medium", color: "text.primary" }}
          >
            Figma Access Token
          </Typography>
          ...
          <Typography variant="caption" color="text.secondary">
            Your token is stored securely in browser local storage. Never share
            your token publicly.
          </Typography>
        </Paper>
        ...
        >
          ...
          <Typography variant="caption" color="text.secondary">
            Copy the link to a specific Figma element by right-clicking it in
            Figma and selecting 'Copy link'.
          </Typography>
        </Paper>
